...
//UNION TYPE APPROACH
// Define a union type for the allowed types in the identity function.
// type AllowedTypes = string | number;

// Use the union type to fix the type errors on Line 13 and 15.
// let value1 = identity<AllowedTypes>("France");
// let value2 = identity<AllowedTypes>(67_413_000);
